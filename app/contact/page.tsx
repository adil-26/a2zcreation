...
export const metadata = {
  ...
  description: "Get in touch for a free consultation and site visit. Call +91 92891 63952.",
};
...
const CONTACT_INFO = [
  ...
  },
  {
    icon: "📧",
    title: "Email Us",
    value: "rumanaa2zcreation@gmail.com",
    sub: "We reply within 24 hours",
    href: "mailto:rumanaa2zcreation@gmail.com",
  },
  {
    icon: "📍",
    title: "Visit Us",
    value: "Jamia Nagar, New Delhi",
    sub: "Friends Colony, 110025",
    href: "#map",
  },
];
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-start">
              ...
              <div className="space-y-8">
                ...
                <div className="p-6 rounded-2xl bg-gradient-to-br from-[#1a1a2e] to-[#0f0f1a] text-center">
                  ...
                  <a href="tel:+919289163952" className="text-white font-bold text-2xl hover:text-[#e75f52] transition-colors">
                    +91 92891 63952
                  </a>
